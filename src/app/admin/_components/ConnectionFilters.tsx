/**
 * ADMIN CONNECTION FILTERS
 *
 * Search controls for connections list.
 *
 * Location: app/admin/connections/_components/ConnectionFilters.tsx
 */
...
export default function ConnectionFilters({ search, status, homeId }: Props) {
